...
Hi Andrej :) I haven't publicized any of this yet so I'm sure this message will only find you. I used to work in genomics from 2008-2014 but have been away from it until the past 6 months. It feels like a cambrian explosion has occurred in terms of applications, data sources, methodologies, etc. However, the barrier for tech folks is quite high, so I decided to write about these topics from a techbio perspective to lower it. Let me know if you're interested in co-writing this and learning more together.
